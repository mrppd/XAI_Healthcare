...
merged_df_FI_ADASYN = merge_dicts_to_dataframe(feature_importances_dt, feature_importances_sh)
merged_df_FI_ADASYN.to_csv('XAI/merged_df_FI_ADASYN.csv', index=True)
print(merged_df_FI_ADASYN)
